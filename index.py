...
def run_program(url_info):
    ...
    if option_chain_df is not None:
        ...
        predefined_symbol_names = {
            'https://webapi.niftytrader.in/webapi/option/fatch-option-chain?symbol=nifty&expiryDate=2024-02-01': 'nityprice',
            'https://webapi.niftytrader.in/webapi/option/fatch-option-chain?symbol=banknifty&expiryDate=2024-02-07': 'bnfprice',
            'https://webapi.niftytrader.in/webapi/option/fatch-option-chain?symbol=finnifty&expiryDate=2024-02-06': 'finniftyprice',
...
# List of URLs
url_infos = [
    {'api_url': 'https://webapi.niftytrader.in/webapi/option/fatch-option-chain?symbol=nifty&expiryDate=2024-02-01'},
    {'api_url': 'https://webapi.niftytrader.in/webapi/option/fatch-option-chain?symbol=banknifty&expiryDate=2024-02-07'},
    {'api_url': 'https://webapi.niftytrader.in/webapi/option/fatch-option-chain?symbol=finnifty&expiryDate=2024-02-06'},
